...
According to this the model is $MA(\theta_1, \text{rep}(0, 0), \Theta_1, \theta_1 \Theta_1)$.

**TODO:** Compare and describe this two plots. Make sure they're correct first.
...
**TODO:** How to check for redundancy? Write the model (after discussion, otherwise you have to do it twice!).
