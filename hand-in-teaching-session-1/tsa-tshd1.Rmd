...
We substitude $y_s = \mu_t + \sigma_t x_t$ (by definition) and we already know that $E[x_t] = \mu_t$.
...
**Invertibility:** As $\forall Z_\phi: |Z_\phi| > 1$ is given, the model is invertible. $|Z_\phi| = \frac{9}{8} = 1.125$.
