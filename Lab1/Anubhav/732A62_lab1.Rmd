...
one_week_lag <- ksmooth(x = df$oil_price_one_diff, y = lag(df$gas_price_one_diff), bandwidth = 0.04, kernel = "normal")
two_week_lag <- ksmooth(x = df$oil_price_one_diff, y = lag(df$gas_price_one_diff,2), bandwidth = 0.04, kernel = "normal")
three_week_lag <- ksmooth(x = df$oil_price_one_diff, y = lag(df$gas_price_one_diff,3), bandwidth = 0.04, kernel = "normal")
